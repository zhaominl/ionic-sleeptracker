...
export class StanfordSleepinessData extends SleepData {
	...
	dateString(): string {
		return this.loggedAt.toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' });
	}

	sumString(): string {
		return 'Logged at ' + this.loggedAt.toLocaleTimeString('en-US') + ', today you feel: ';
	}
